...
if(isset($_POST['submit']))
{
    ...
    {
        // Use typed filename if no file uploaded
        $imageName = $_POST['image'];
    }

    $insert = $connection->prepare("INSERT INTO scp(item_number, object_class, containment, description, image) VALUES(?,?,?,?,?)");
    $insert->bind_param("sssss", $_POST['item_number'], $_POST['object_class'], $_POST['containment'], $_POST['description'], $imageName);
    ...
    {
        $insertError = "Error: " . $insert->error;
    }
}
...
<title>SCP Foundation - Add New Record</title>
...
<div class="container">
    ...
    <?php
    if(isset($uploadError)) echo "<div class='alert-danger'>" . $uploadError . "</div>";
    if(isset($insertError)) echo "<div class='alert-danger'>" . $insertError . "</div>";
    ?>
    ...
    <div class="card">
        <div class="card-inner">
            <form method="post" action="create.php" enctype="multipart/form-data">
                ...
                <input type="text" name="item_number" placeholder="e.g. SCP-173" class="form-control" required>
                ...
                <textarea name="containment" class="form-control" placeholder="Containment procedures..." required></textarea>

                <label>Description</label>
                <textarea name="description" class="form-control" placeholder="Description of the SCP..." required></textarea>

                <label>Image</label>
                <div class="upload-row">
                    <input type="text" name="image" placeholder="e.g. SCP_173.jpg" class="form-control" id="imageFilename">
                ...
                <small>Type a filename OR click Upload to choose from your gallery.</small>

                <div class="btn-row">
                    <input type="submit" name="submit" value="Create Record" class="btn btn-submit">
